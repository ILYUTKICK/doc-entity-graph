"""
═══════════════════════════════════════════════════════════════
  Фаза 4: Построение графа сущностей
  Проект: Построение графа сущностей документов
═══════════════════════════════════════════════════════════════

Вход:  *_entities.json из Фазы 3
Выход: граф сущностей (GraphML + JSON + HTML визуализация)

Логика построения:
  1. Загрузка сущностей из всех документов
  2. Cross-document entity resolution (дедупликация)
  3. Построение рёбер по co-occurrence в чанках
  4. Расчёт метрик графа (degree, PageRank, communities)
  5. Экспорт + интерактивная визуализация

Установка:
  pip install networkx pyvis

Запуск:
  python phase4_graph.py -i ./entities/ -o ./graph/
"""
